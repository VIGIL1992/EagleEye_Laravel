            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide" style="background-image: url({{ url('frontend/images/main-slider/bck.jpg') }});">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner">
                                <h1>Trading the <span>latest</span><br>electrical equipment <br>and tools.</h1>
                                <div class="text">We carry a wide range of quality materials to meet industry requirements.</div>
                                <div class="link-box">
                                    <a href="about.php" class="theme-btn btn-style-one"><span>About Us</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide" style="background-image: url({{ url('frontend/images/main-slider/bck_2.jpg') }});">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner">
                                <h1>Dealing in <br>cutting-edge <br>electrical gear.</h1>
                                <div class="text">We carry a wide range of quality materials to meet industry requirements.</div>
                                <div class="link-box">
                ...
                <div class="col-xl-6">
                    <div class="about-two-right-content">
                        <div class="about-two-title">
                            ...
                            <h2>Welcome to Eagle Eye a leading trading company </h2>
    ...
    <section class="team-one-section two">
        <div class="container">
            <div class="thm-section-title text-center">
                <h4 class="sub-title-shape-left section_title-subheading">See Our Products</h4>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                            <a href="product.php" class="theme-btn">More Products</a>
                </div>
            </div>
        </div>
    </section>
